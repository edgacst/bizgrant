...
export const CHATBOT_WELCOME =
  '안녕하세요! BizGrant 도우미입니다.\n아래 자주 묻는 질문을 누르거나, 궁금한 내용을 입력해 주세요.';
...
export const CHATBOT_FAQ: ChatFaqItem[] = [
  {
    ...
    keywords: ['소개', '뭐예요', '무엇', 'bizgrant', '비즈그랜트', '서비스'],
  },
  {
    id: 'target',
    category: '서비스',
    question: '누가 쓰면 좋아요?',
    answer: '중소기업·스타트업·1인 사업자, 지원금·입찰 공고를 챙겨야 하는 실무자에게 적합합니다.',
    keywords: ['대상', '누가', '추천', '사업자'],
  },
  {
    id: 'diff',
    category: '서비스',
  ...
  },
  {
    ...
    question: '가입 방법',
    answer:
      'bizgrant.kr 접속 → 회원가입 → 이메일·비밀번호·회사 정보 입력 → 로그인 후 이용하세요.\n회원가입만 하면 모든 기능을 이용할 수 있습니다.',
    keywords: ['가입', '회원가입', '시작', '등록'],
  },
  {
    id: 'login-required',
    category: '가입',
